...
while True:
    ...
    circlesLeft, maskLeft = Cutils.find_circles(frameLeft)
    circlesRight, maskRight = Cutils.find_circles(frameRight)
    Cutils.find_circles(frameRight)
    ...
    Cutils.draw_circles(frameLeft, circlesLeft)
    Cutils.draw_circles(frameRight, circlesRight)
